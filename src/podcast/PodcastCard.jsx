  ...
  return (
    <div className="relative bg-gray-900 rounded-3xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden">
      ...
      <div className="p-5 space-y-3 text-white">
        ...
        <div className="flex justify-center gap-4 flex-wrap text-sm text-gray-200">
      ...
      <button
        ...
        className="absolute top-3 right-3 bg-gray-300 bg-opacity-80 p-2 rounded-full hover:bg-red-600 transition"
      >
