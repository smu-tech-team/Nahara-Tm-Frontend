...
const RecentLiveNews = () => {
  ...
  const [newsPerPage] = useState(10); // Define number of items per page
  ...
  const copyToClipboard = (link) => {
    const myWebsiteUrl = "https://www.yourwebsite.com"; // Replace with your actual website URL
